...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'home_hero_subtitle',       'group' => 'home', 'type' => 'textarea', 'label' => 'Hero sous-titre',           'value' => 'Rejoins 900+ développeurs ivoiriens, partage, apprends et grandis avec la communauté.',                           'order' => 3],
            ...
            ['key' => 'home_cta_banner_text',     'group' => 'home', 'type' => 'textarea', 'label' => 'Bannière CTA texte',        'value' => 'Connecte-toi avec GitHub, pose ta première question et rejoins 900+ développeurs qui progressent ensemble.',        'order' => 10],
