            ...
            <div class="space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea wire:model.blur="content"
                        ...
                        class="w-full resize-none rounded-lg border px-3.5 py-2.5 font-mono text-sm leading-relaxed text-gray-900 placeholder:text-gray-400 transition-colors focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-black/10 @error('content') border-red-400 focus:ring-red-100 @else border-gray-200 @enderror">
                    </textarea>
                    @error('content')
                        <p class="flex items-center gap-1 text-xs text-red-500">
                            <svg class="size-3 shrink-0" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
