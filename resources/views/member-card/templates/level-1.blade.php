...
.card{
  ...
  background:linear-gradient(140deg,#b84208 0%,#e8590c 30%,#ff7830 60%,#ffab40 85%,#e8590c 100%);
...
/* QR stylisé comme la puce */
.qr-chip{position:relative;width:56px;height:56px;border-radius:8px;background:#fff;overflow:hidden;flex-shrink:0;box-shadow:0 0 0 2px rgba(255,255,255,.9),0 0 0 4.5px rgba(232,89,12,.5),0 4px 14px rgba(0,0,0,.35)}
.qr-chip svg{width:56px!important;height:56px!important;display:block}
.qr-chip-empty{width:100%;height:100%;background:repeating-linear-gradient(0deg,#e8590c 0,#e8590c 3px,transparent 3px,transparent 8px),repeating-linear-gradient(90deg,#e8590c 0,#e8590c 3px,transparent 3px,transparent 8px);opacity:.18}
...
/* ── BOTTOM — padding-right pour laisser la place à la mascotte ── */
